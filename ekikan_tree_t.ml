...
(* テスト *)
(* let test1 = get_ekikan_kyori "佐賀市" "佐賀市" global_ekikan_tree = infinity *)
let test2 = get_ekikan_kyori "平和台" "営団赤塚" global_ekikan_tree = 1.8
let test3 = get_ekikan_kyori "営団成増" "和光市" global_ekikan_tree = 2.1
let test4 = get_ekikan_kyori "六本木" "神谷町" global_ekikan_tree = 1.5
